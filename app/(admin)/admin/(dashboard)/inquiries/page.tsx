                      ...
                      <div className="mt-4 p-4 bg-slate-50 border border-slate-200 rounded-lg">
                        ...
                        <div className="flex gap-2 mt-2">
                          <button
                            ...
                            className="px-4 py-1.5 text-sm font-semibold rounded-lg bg-[#C9A84C] text-white hover:bg-[#b8923d] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                          >
                            {sendingReply ? 'Sending...' : '✉ Send Reply'}
                          </button>
                          <button
                            onClick={cancelReply}
                            className="px-4 py-1.5 text-sm text-slate-500 border border-slate-300 rounded-lg hover:bg-slate-100 transition-colors"
                          >
                            Cancel
                          </button>
                        </div>
