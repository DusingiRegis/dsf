...
export default function ClientEditProperty({ property }: Props) {
  ...
  try {
    initialVideos = JSON.parse(property.videos);
  } catch {
    initialVideos = [];
  }
  ...
  const [videoUrls, setVideoUrls] = useState<string[]>(initialVideos);
